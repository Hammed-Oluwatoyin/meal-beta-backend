...
export class InitBaseline1700000000000 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."profiles_healthgoals_enum" AS ENUM('WEIGHT_LOSS', 'WEIGHT_GAIN', 'MAINTENANCE', 'MUSCLE_GAIN', 'GENERAL_HEALTH', 'MANAGE_CONDITION')`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."profiles_activitylevel_enum" AS ENUM('LOW', 'MODERATE', 'HIGH')`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."profiles_plantype_enum" AS ENUM('SINGLE', 'COUPLE', 'FAMILY')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."meal_plan_entries_slot_enum" AS ENUM('BREAKFAST', 'LUNCH', 'DINNER', 'SNACK')`,
    );
    await queryRunner.query(
      `CREATE TABLE "meal_plan_entries" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "mealPlanId" uuid NOT NULL, "mealId" uuid NOT NULL, "dayOfWeek" integer NOT NULL, "slot" "public"."meal_plan_entries_slot_enum" NOT NULL, "isCompleted" boolean NOT NULL DEFAULT false, "completedAt" TIMESTAMP WITH TIME ZONE, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "UQ_e59db9288416144db4d7bc8579c" UNIQUE ("mealPlanId", "dayOfWeek", "slot"), CONSTRAINT "PK_8384d591c94bb96697f81749b09" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."meals_tags_enum" AS ENUM('VEGETARIAN', 'VEGAN', 'GLUTEN_FREE', 'DAIRY_FREE', 'LOW_CARB', 'DIABETIC_FRIENDLY', 'HEART_HEALTHY', 'LOW_SODIUM', 'HIGH_PROTEIN', 'NUT_FREE')`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."meals_defaultslot_enum" AS ENUM('BREAKFAST', 'LUNCH', 'DINNER', 'SNACK')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "shopping_lists" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "userId" uuid NOT NULL, "mealPlanId" uuid NOT NULL, "generatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_9289ace7dd5e768d65290f3f9de" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."users_role_enum" AS ENUM('PATIENT', 'DIETITIAN', 'ADMIN')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "custom_meal_requests" ADD CONSTRAINT "FK_6275c616b1e2cadf48bf6ab7a2a" FOREIGN KEY ("patientId") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "custom_meal_requests" ADD CONSTRAINT "FK_145af0e3d5b66803826a369dcca" FOREIGN KEY ("dietitianId") REFERENCES "users"("id") ON DELETE SET NULL ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "custom_meal_requests" ADD CONSTRAINT "FK_0843498f64657acc4164ff48fe6" FOREIGN KEY ("resultingMealPlanId") REFERENCES "meal_plans"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "meal_plans" ADD CONSTRAINT "FK_0ecd9a18e96ee4250df102abccd" FOREIGN KEY ("patientId") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "meal_plans" ADD CONSTRAINT "FK_629523721be05773c614e6e44e8" FOREIGN KEY ("dietitianId") REFERENCES "users"("id") ON DELETE SET NULL ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "meal_plan_entries" ADD CONSTRAINT "FK_524b085da93decd945e8e0364c3" FOREIGN KEY ("mealId") REFERENCES "meals"("id") ON DELETE RESTRICT ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "meals" ADD CONSTRAINT "FK_1e5718c737b6fe4c5369646fd98" FOREIGN KEY ("createdById") REFERENCES "users"("id") ON DELETE SET NULL ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "progress_logs" ADD CONSTRAINT "FK_92b6044d361009434bf61ed1b48" FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "shopping_lists" ADD CONSTRAINT "FK_02e874eab565a8c91f4623ec43e" FOREIGN KEY ("mealPlanId") REFERENCES "meal_plans"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "shopping_lists" DROP CONSTRAINT "FK_02e874eab565a8c91f4623ec43e"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "progress_logs" DROP CONSTRAINT "FK_92b6044d361009434bf61ed1b48"`,
    );
    await queryRunner.query(
      `ALTER TABLE "meals" DROP CONSTRAINT "FK_1e5718c737b6fe4c5369646fd98"`,
    );
    await queryRunner.query(
      `ALTER TABLE "meal_plan_entries" DROP CONSTRAINT "FK_524b085da93decd945e8e0364c3"`,
    );
    await queryRunner.query(
      `ALTER TABLE "meal_plan_entries" DROP CONSTRAINT "FK_04054fc6ab06c6e4808a0f12a4e"`,
    );
    await queryRunner.query(
      `ALTER TABLE "meal_plans" DROP CONSTRAINT "FK_629523721be05773c614e6e44e8"`,
    );
    await queryRunner.query(
      `ALTER TABLE "meal_plans" DROP CONSTRAINT "FK_0ecd9a18e96ee4250df102abccd"`,
    );
    await queryRunner.query(
      `ALTER TABLE "custom_meal_requests" DROP CONSTRAINT "FK_0843498f64657acc4164ff48fe6"`,
    );
    await queryRunner.query(
      `ALTER TABLE "custom_meal_requests" DROP CONSTRAINT "FK_145af0e3d5b66803826a369dcca"`,
    );
    await queryRunner.query(
      `ALTER TABLE "custom_meal_requests" DROP CONSTRAINT "FK_6275c616b1e2cadf48bf6ab7a2a"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `DROP TYPE "public"."custom_meal_requests_status_enum"`,
    );
